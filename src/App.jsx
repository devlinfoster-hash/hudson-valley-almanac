...
<footer style={{
  ...
  <div style={{ maxWidth: '800px', margin: '0 auto' }}>
    ...
    <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', flexWrap: 'wrap', marginBottom: '24px' }}>
      <a href="mailto:hello@hudsonvalleyalmanac.com" style={{ color: '#c9b89a', textDecoration: 'none', fontSize: '0.9rem' }}>
        📬 Contact Us
      </a>
      <a href="mailto:hello@hudsonvalleyalmanac.com?subject=Add My Business to Hudson Valley Almanac" style={{ color: '#c9b89a', textDecoration: 'none', fontSize: '0.9rem' }}>
        ➕ Submit a Listing
      </a>
      <a href="mailto:hello@hudsonvalleyalmanac.com?subject=Report an Error - Hudson Valley Almanac" style={{ color: '#c9b89a', textDecoration: 'none', fontSize: '0.9rem' }}>
        ✏️ Report an Error
      </a>
    </div>

    <p style={{ fontSize: '0.78rem', color: '#7a6555', marginBottom: '24px', lineHeight: '1.6' }}>
      Serving Albany · Rensselaer · Saratoga · Schenectady · Washington · Columbia · Greene · Delaware · Schoharie · Ulster · Dutchess · Sullivan · Orange · Putnam · Westchester Counties
    </p>
